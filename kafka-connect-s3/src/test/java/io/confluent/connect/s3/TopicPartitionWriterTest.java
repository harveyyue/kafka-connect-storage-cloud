...
public class TopicPartitionWriterTest extends TestWithMockedS3 {
  ...
  public void testWriteRecordRotateFileMultipleSchema() throws Exception {
    ...
    localProps.put(S3SinkConnectorConfig.ROTATE_FILE_MULTIPLE_SCHEMA, "false");
    ...
    localProps.put(StorageSinkConnectorConfig.ROTATE_SCHEDULE_INTERVAL_MS_CONFIG, "60000");
    localProps.put(StorageSinkConnectorConfig.FLUSH_SIZE_CONFIG, "10");
    ...
    // Mock sink records
    List<SinkRecord> sinkRecords = createTwoSchemaRecords(10);
  ...
  private List<SinkRecord> createTwoSchemaRecords(int size) {
    String key = "key";
  ...
  public void testWriteRecordDefaultWithPaddingSeq() throws Exception {
    ...
    Schema newSchema = createNewSchema();
    List<Struct> newRecords = createRecordBatch(newSchema, 10);

    List<SinkRecord> sinkRecords = createSinkRecords(records, key, schema);
    sinkRecords.addAll(createSinkRecords(newRecords, key, newSchema));
    Collections.shuffle(sinkRecords);
